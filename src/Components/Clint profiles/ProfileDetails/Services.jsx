...
function Services() {
  ...
  return (
    <div className='w-full flex flex-col gap-5 p-2 rounded-lg '>
        ...
        <div className={`${open ? 'w-full h-[100vh] top-0 right-0 sm:top-0 sm:left-0 bg-zinc-200 sm:bg-zinc-50/10' : ' w-full h-full sm:h-0 top-0 -right-full sm:-top-full sm:left-0 '} absolute transition-smooth-from-css overflow-hidden`}>
