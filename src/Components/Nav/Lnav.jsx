...
function Lnav() {
  return (
          <div className='w-full sm:w-20 h-full bg-zinc-100 flex flex-row sm:flex-col items-center justify-between p-3 sm:pb-5 '>
     <ul className='flex flex-row sm:flex-col items-center justify-start gap-3 py-2 px-2'>
          ...
          <li><NavLink to="/contact" className={({isActive})=>`${isActive ? "bg-zinc-700  text-zinc-300 hover:text-zinc-800 transition-all" : "bg-transparent transition-all "} p-1.5 rounded-md hover:bg-zinc-700/20 `}><i class="ri-contacts-fill text-xl font-medium "></i></NavLink></li>
