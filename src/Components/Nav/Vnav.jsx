...
function Vnav() {
  ...
  return (
    <div className='w-full sm:w-20 h-fit sm:h-full bg-zinc-900 flex flex-row sm:flex-col border-b sm:border-r border-zinc-400 items-center justify-between py-3 sm:pb-5 '>
