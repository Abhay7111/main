...
function Home() {
  return (
     <div className='flex sm:flex-row flex-col calc-h bg-zinc-900'>
          ...
          <div className='relative w-full sm:w-[30vw] px-3 h-fit sm:h-screen overflow-y-auto calc-h border-l border-zinc-500'>
          <div className='w-full mt-5 rounded-lg p-1 text-zinc-300 h-fit sm:min-h-30 bg-zinc-800'>
          <Webdetails/>
          </div>
          </div>
          </div>
